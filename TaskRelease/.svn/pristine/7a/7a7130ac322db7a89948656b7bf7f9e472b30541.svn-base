...
namespace SingleTableCRUD
{
    ...
    { 
        ...
        public static SqlDataReader ExecuteReader(string strSQL, string connectionStrings)
        {
        ...
        public static int RunProcedure(string connectionStrings, string storedProcName, IDataParameter[] parameters, out int rowsAffected)
        {
